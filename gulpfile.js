...
// npm install --save-dev gulp-autoprefixer gulp-bless gulp-bower gulp-concat gulp-livereload gulp-plumber gulp-sass gulp-size gulp-sourcemaps gulp-svgmin gulp-uglify 
//bower install --save-dev jquery normalize.css fontawesome 
...
var config = {
	...
	rawjsDir: 'raw_javascript',
	rawsvgDir: 'raw_svg',
	imageDir: 'img',
	fontDir: 'fonts',

	jsExportFile: 'scripts',
     sassMainFile: 'style'
...
gulp.task('sizeReport', function() {
    	 gulp.src([ config.jsExportFile+'.js', 'css/'+config.sassMainFile+'.css' ])
